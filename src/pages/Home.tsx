    ...
    <div className="bg-white">
      ...
      <div className="relative bg-gray-900">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Erra Law Firm</h1>
          ...
          <div className="mt-10 flex space-x-4">
            <Link
              to="/contact"
              className="inline-block bg-[rgba(116,192,22,0.83)] py-3 px-6 border border-transparent rounded-md text-base font-medium text-white hover:bg-green-600"
            >
              Contact Us
            </Link>
            <Link
      ...
      <div className="bg-gray-300 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-[rgba(116,192,22,0.83)] font-semibold tracking-wide uppercase">Practice Areas</h2>
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    <div>
                      <span className="inline-flex items-center justify-center p-3 bg-[rgba(116,192,22,0.83)] rounded-md shadow-lg">
      ...
      <div className="bg-gray-300 py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-[rgba(116,192,22,0.83)] font-semibold tracking-wide uppercase">Testimonials</h2>
            <p className="mt-2 text-3xl font-extrabold text-gray-900 sm:text-4xl">
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-3">
            <div className="bg-white shadow-lg rounded-lg p-8">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-[rgba(116,192,22,0.83)]">Business Client</p>
                </div>
              </div>
            ...
            <div className="bg-white shadow-lg rounded-lg p-8">
              <div className="flex items-center">
                <div className="flex-shrink-0 h-12 w-12 rounded-full bg-gray-200 flex items-center justify-center">
                  <span className="text-gray-700 font-bold text-lg">SM</span>
                </div>
                <div className="ml-4">
                  <h4 className="text-lg font-bold">Sarah Miller</h4>
                  <p className="text-[rgba(116,192,22,0.83)]">Real Estate Client</p>
                </div>
              </div>
              <p className="mt-4 text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-lg p-8">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-[rgba(116,192,22,0.83)]">Family Law Client</p>
                </div>
              </div>
              <p className="mt-4 text-gray-600">
