  ...
  return (
    <div>
      ...
      <section className="py-20 px-4 bg-indigo-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-indigo-900 mb-4">Our Mission & Values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Integrity</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Dedication</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold text-indigo-900 mb-3">Client-Focused</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-indigo-900 mb-4">Our Legal Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-indigo-900 mb-1">Jonathan Lawson</h3>
                <p className="text-indigo-600 mb-4">Founding Partner</p>
                <p className="text-gray-600 mb-4">
                ...
                <p className="text-indigo-900 font-medium">Areas of Practice:</p>
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-indigo-900 mb-1">Sarah Thompson</h3>
                <p className="text-indigo-600 mb-4">Senior Partner</p>
                <p className="text-gray-600 mb-4">
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-indigo-900 mb-1">Michael Rodriguez</h3>
                <p className="text-indigo-600 mb-4">Partner</p>
                <p className="text-gray-600 mb-4">
          ...
          <div className="text-center mt-12">
            <Link to="/contact" className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-md transition-colors font-medium">
