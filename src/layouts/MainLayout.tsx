          ...
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <Link to="/" className="flex items-center">
                <span className="text-2xl font-serif font-bold text-gray-800">Erra Law</span>
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link 
                to="/" 
                className={`${location.pathname === '/' ? 'text-gray-800 border-b-2 border-gray-800' : 'text-gray-800 hover:text-white'} transition-colors duration-200 px-1 py-2 text-sm font-medium`}
              >
                Home
              </Link>
              <Link 
                to="/about" 
                className={`${location.pathname === '/about' ? 'text-gray-800 border-b-2 border-white' : 'text-gray-800 hover:text-white'} transition-colors duration-200 px-1 py-2 text-sm font-medium`}
              >
                About Us
              </Link>
              <Link 
                to="/services" 
                className={`${location.pathname === '/services' ? 'text-gray-800 border-b-2 border-white' : 'text-gray-800 hover:text-white'} transition-colors duration-200 px-1 py-2 text-sm font-medium`}
              >
                Practice Areas
              </Link>
              <Link 
                to="/contact" 
                className={`${location.pathname === '/contact' ? 'text-gray-800 border-b-2 border-white' : 'text-gray-800 hover:text-white'} transition-colors duration-200 px-1 py-2 text-sm font-medium`}
              >
                Contact
              </Link>
              <Link 
      ...
      <footer className="bg-[rgba(116,192,22,0.83)] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-serif font-bold mb-4 text-gray-800">Erra Law</h3>
            ...
            <div>
              <h3 className="text-xl font-serif font-bold mb-4 text-gray-800">Contact Info</h3>
              <p className="text-gray-800 text-sm mb-2">2601 South Bayshore Drive, 18th Floor</p>
              <p className="text-gray-800 text-sm mb-2">Coconut Grove, FL 33133</p>
              <p className="text-gray-800 text-sm mb-2">Phone: (305) 444-5969</p>
              <p className="text-gray-800 text-sm">Email: info@erralaw.com</p>
            </div>
            <div>
              <h3 className="text-xl font-serif font-bold mb-4 text-gray-800">Practice Areas</h3>
              <ul className="space-y-2 text-gray-800 text-sm">
                <li><a href="#" className="hover:text-gray-800 transition-colors duration-200">Business Law</a></li>
                <li><a href="#" className="hover:text-gray-800 transition-colors duration-200">Family Law</a></li>
                <li><a href="#" className="hover:text-gray-800 transition-colors duration-200">Personal Injury</a></li>
                <li><a href="#" className="hover:text-gray-800 transition-colors duration-200">Real Estate Law</a></li>
                <li><a href="#" className="hover:text-gray-800 transition-colors duration-200">Estate Planning</a></li>
              </ul>
            </div>
          </div>
